    ...
    <div class="container">
        ...
        <form action="{{ route('pasien.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" id="nama" name="nama" required placeholder="Masukkan nama pasien">
            </div>

            <div class="form-group">
                <label for="nomor_identitas">Nomor Identitas (KTP/Paspor) *</label>
                <input type="text" id="nomor_identitas" name="nomor_identitas" required placeholder="Masukkan nomor identitas">
            </div>
